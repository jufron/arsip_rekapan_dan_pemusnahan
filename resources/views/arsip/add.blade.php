                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('perihal') is-invalid @enderror" id="perihal" name="perihal" rows="5">{{ old('perihal') }}</textarea>
                                @error('perihal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <select class="form-control @error('disposisi_id') is-invalid @enderror" id="disposisi_id" name="disposisi_id">
                                ...
                                <option value="{{ $dis->id }}">{{ $dis->nama_disposisi }}</option>
                                @endforeach
                            </select>
                            @error('disposisi_id')
                            <div class="invalid-feedback">

        ...
        <div class="row">
            ...
            <div class="col-xl-6 row">
                ...
                <div class="col-xl-6 col-md-6 mb-4">
                    <a href="{{ route('arsip.get.where', 'rekapan_&_pemusnahan') }}" class="text-decoration-none">
                ...
                <!-- Earnings (Monthly) Card Example -->
                <div class="col-xl-6 col-md-6 mb-4">
                    <a href="{{ route('arsip.get.where', 'arsip_pemusnahan') }}" class="text-decoration-none">
                ...
                <!-- Earnings (Monthly) Card Example -->
                <div class="col-xl-6 col-md-6 mb-4">
                    <a href="{{ route('arsip.get.where', 'arsip_date_now') }}" class="text-decoration-none">
                ...
                <div class="col-xl-6 col-md-6 mb-4">
                    <a href="{{ route('arsip.get.where', 'arsip') }}" class="text-decoration-none">
